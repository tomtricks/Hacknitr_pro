...
from tryblog.models import Profile
...
class PasswordChangingForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(max_length=100,label="New Password", widget=forms.PasswordInput(attrs={'class':'form-control','type':'password','placeholder':'Enter new password'}))
    new_password2 = forms.CharField(max_length=100,label="Password Confirmation", widget=forms.PasswordInput(attrs={'class':'form-control','type':'password','placeholder':'Reconfirm your new password'}))
...
class ProfilePageForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
                ...
                'bio':forms.Textarea(attrs={'class':'form-control','type':'text'}),
                # 'profile_pic':forms.TextInput(attrs={'class':'form-control'}),
                'website_url':forms.TextInput(attrs={'class':'form-control','type':'url'}),
                ...
                'twitter_url':forms.TextInput(attrs={'class':'form-control','type':'url'}),
